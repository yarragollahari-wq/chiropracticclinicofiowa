...
export default function Faq() {
  ...
  return (
    <section id="faq" className="panel mt-4 bg-white py-24 lg:py-32">
      <div className="shell">
        <SectionHeading
          eyebrow="FAQs"
          lines={["Everything patients", "ask us first"]}
        />

        <div className="mt-14 rounded-[20px] bg-[var(--color-surface)] p-3 lg:mt-16">
          {faqs.map((f, i) => {
            const isOpen = open === i;
            return (
              <motion.div
